...
def FrontLogin():
    ...
    if request.method == "POST":
        ...
        #print userKey
        #print password
        blockInfo = {"userKey":userKey,"password":password,"userType":userType}
...
def FrontLogout():
    ...
    if request.method == "POST":
        ...
        print token
        blockInfo = {"token":token,"username":"name 0"}
...
def FrontSearchBook():
    ...
    if request.method == "GET":
        ...
        blockInfo ={"bookname":bookname,"booktype":booktype,"ISBN":ISBN,"token":token}
        fromX = X.searchBook(blockInfo)
        if fromX["Status"] == "Success":
            bodyinfo["type"] = "succeed"
            bodyinfo["data"] = {"bookList":fromX["booklist"]}
